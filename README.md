...
| 3 | планирование рекламной компании | Первый сборный проект|Matplotlib, NumPy, Pandas, Python, SciPy, Missingo, описательная статистика, проверка статистических гипотез | На основе исторических данных предсказать популярные игровые платформы на предстоящий год и выдать рекомендации по реализации рекламных компаний |
